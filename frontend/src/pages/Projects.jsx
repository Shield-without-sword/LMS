...
import { FaProjectDiagram, FaCode, FaClipboardList, FaSignOutAlt } from "react-icons/fa";
        ...
        <div className="flex flex-col h-screen bg-gray-50">
            ...
            <main className="flex-1 p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        { label: "Ongoing Projects", value: "6", icon: <FaProjectDiagram />, color: "blue" },
                        { label: "Completed Projects", value: "12", icon: <FaCode />, color: "green" },
                        { label: "Pending Reviews", value: "3", icon: <FaClipboardList />, color: "purple" },
                    ].map((card, index) => (
